...
// 		},
// 		url: "<insert address>/comet/STH/v1/contextEntities/type/AirQualityObserved/id/<insert id>/attributes/<insert atrributes>?aggrMethod=max&aggrPeriod=minute&dateFrom=2019-01-01T00:00&dateTo=2019-05-15T00:00",
// 	},
// 	"Room 116" : {
// 		Headers : {
// 			"Fiware-ServicePath" : "<servicePath",
// 			"Fiware-Service" : "<service>",
// 		},
// 		url: "<insert address>/comet/STH/v1/contextEntities/type/AirQualityObserved/id/<insert id>/attributes/<insert attributues?aggrMethod=max&aggrPeriod=minute&dateFrom=2019-01-01T00:00&dateTo=2019-05-15T00:00",
// 	},
// };
	...
	btn.onclick = async function() {
		...
		if (!activated) {
			...
			if (object.AutomatedTime) {
				...
				var response = await browser("<insert address>", headers);
...
function getHeader(servicePath, service) {
	...
	return new Promise(resolve => {
		setTimeout(() => {
			...
			"Fiware-Service": service,
			"Fiware-ServicePath": servicePath,
			"Platform-ApiKey": "insert apikey here",
			};
			resolve(header);
		}, 50);
	});
